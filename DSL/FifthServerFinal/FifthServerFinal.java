...
public class FifthServerFinal {
	public static void main(String args[]) { 
		int port = 6789;
		FifthServerFinal server = new FifthServerFinal( port );
		server.startServer(); 
	}
	...
	int port;
	public FifthServerFinal( int port ) {
		this.port = port;
	}
...
{ 
	...
	Socket clientSocket;
	int id;
	FifthServerFinal server;
	public Server2Connection(Socket clientSocket, int id, FifthServerFinal server) 
	{ 
